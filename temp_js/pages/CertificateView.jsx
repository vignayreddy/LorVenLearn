...
export default function CertificateView() {
    ...
    return (<div className="max-w-5xl mx-auto py-8 px-4">
      ...
      {/* Certificate UI */}
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="bg-white border-[12px] border-zinc-900 p-1 rounded-sm shadow-2xl relative overflow-hidden print:shadow-none print:border-[8px]">
        {/* Decorative elements */}
