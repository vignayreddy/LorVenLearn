  ...
  return <div className="space-y-12">
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          r: 5,
          date: "2 days ago",
          txt: "This curriculum is insanely good. The way it breaks down complex architectural patterns into bite-sized mental models completely changed how I build systems."
        }, {
          name: "Priya Patel",
          role: "Frontend Lead",
          r: 5,
          date: "1 week ago",
          txt: "Worth every penny. The project-based approach ensures you aren't just stuck in tutorial hell. Highly recommend to any dev looking to level up."
        }, {
          name: "Arjun K.",
          role: "Student",
          r: 4,
          date: "3 weeks ago",
          txt: "Extremely in-depth. Sometimes the pace is a bit fast, but pausing to re-watch the tricky parts resolves that. The Q&A community is also super helpful."
        }, {
          name: "DevOps Mike",
          role: "SysAdmin",
          r: 5,
          date: "1 month ago",
          txt: "I use these patterns in production now. The instructor knows exactly what industry standards are currently."
